...
class Body:
    ...
    def write(self):
        ...
        self.pen.write(
            "a) Press 's' in the keyboard and click anywhere on grid to place the starting point.(color: green)", False,
            align="left", font=("arial", 10, "bold"))
        self.pen.goto(-480, 230)
        self.pen.write("b) Press 'e' in the keyboard and click anywhere on grid to place the ending point.(color:blue)",
                       False, align="left", font=("arial", 10, "bold"))
        self.pen.goto(-480, 210)
        self.pen.write("c) Press 'h' in the keyboard and click anywhere on grid to place the hurdles.(color: red)",
                       False, align="left", font=("arial", 10, "bold"))
        self.pen.goto(-480, 190)
        self.pen.write("d) Press 'r' in the keyboard to place some random hurdles on the grid.", False, align="left",
                       font=("arial", 10, "bold"))
        self.pen.goto(-480, 170)
        self.pen.write("e) Press 'space bar' in the keyboard to see the shortest path(colored in black)", False,
                       align="left", font=("arial", 10, "bold"))
        self.pen.goto(-480, 150)
        self.pen.write("f) Press 'o' in the keyboard to clear the grid.", False, align="left",
                       font=("arial", 10, "bold"))
